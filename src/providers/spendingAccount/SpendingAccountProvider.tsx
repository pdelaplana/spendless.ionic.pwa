  ...
  const startPeriod = useCallback(
    async (data: Partial<IPeriod>) => {
      try {
        ...
        // Recurring spends are now auto-generated by useCreatePeriod via useGenerateRecurringSpends
        // No need to copy old recurring spends anymore
    ...
    [currentPeriod, closePeriod, spendingAccount?.id, createPeriod],
  );
